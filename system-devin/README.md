...
description: Canonical DREP coordination root for mos2es-site. rep1=LEAD, rep2=ASSIST, OWNER=human. Single operational coordination state.
...
This directory is the canonical DREP coordination root for `mos2es-site`.
